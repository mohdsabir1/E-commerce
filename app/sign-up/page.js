    ...
    <div className=" mt-10 flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
        <div className="px-6 py-8">
          <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">Create Acount</h2>
          <p className="text-center text-gray-600 mb-8">Enter your email ,Username and password to Sign up</p>
